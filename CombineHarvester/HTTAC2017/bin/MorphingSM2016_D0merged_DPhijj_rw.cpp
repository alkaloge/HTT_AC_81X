...
#include "CombineHarvester/HTTAC2017/interface/HttSystematics_SMRun2_D0merged_DCP_ggHSyst_fL1_rw.h"
...
//    
    ...
    ch::AddSMRun2Systematics_D0merged_DCP_ggHSyst_fL1_rw(cb, control_region, mm_fit, ttbar_fit);
	...
	if(chn != std::string("ttbar")){
	  ...
	  cout << "             ---> signals: "<< sig_procs_ttbar[0]<< ", "<< sig_procs_ttbar[1]<< ", "<< sig_procs_ttbar[2]<< ", "<< sig_procs_ttbar[3]<< endl;
